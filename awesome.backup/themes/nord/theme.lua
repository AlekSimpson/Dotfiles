...
themes_dir 		= os.getenv("HOME") .. "/.config/awesome/themes/nord"
...
theme.fg_focus   = "#88C0D0" -- 88C0D0
theme.fg_urgent  = "#D08770"
theme.bg_normal  = "#2E3440"
theme.bg_focus   = "#3B4252" -- 3B4252
...
-- {{{ Titlebars
theme.titlebar_bg_focus   = "#FB4570"
...
theme.taglist_fg_focus = "#ffffff" -- ffffff
